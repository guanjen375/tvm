...
/*!
 * \file codegen_snps_ev.h
 * \brief Generate snps_ev device code.
 */
#ifndef TVM_CODEGEN_CODEGEN_SNPS_EV_H_
#define TVM_CODEGEN_CODEGEN_SNPS_EV_H_
...
class CodeGenSNPS_EV final : public CodeGenC {
 public:
  CodeGenSNPS_EV();
...
#endif  // TVM_CODEGEN_CODEGEN_SNPS_EV_H_
