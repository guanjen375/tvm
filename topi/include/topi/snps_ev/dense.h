...
/*!
 * \file snps_ev/dense.h
 * \brief snps_ev schedule for dense operation
 */
#ifndef TOPI_SNPS_EV_DENSE_H_
#define TOPI_SNPS_EV_DENSE_H_
...
namespace snps_ev {
/*!
* \brief Implementation of dense for snps_ev backend
*
...
*/
inline tvm::Tensor dense_snps_ev(const Target& target,
...
/*!
* \brief Create a snps_ev schedule for dense
*
