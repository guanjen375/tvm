...
/*!
 * \file snps_ev/injective.h
 * \brief snps_ev schedule for injective operations
 */
#ifndef TOPI_SNPS_EV_SOFTMAX_H_
#define TOPI_SNPS_EV_SOFTMAX_H_
...
/*!
 * \brief Create a snps_ev schedule for the given softmax output tensors.
 *
