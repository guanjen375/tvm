...
/*!
 * \file snps_ev/pooling.h
 * \brief snps_ev schedule for pooling operations
 */
#ifndef TOPI_SNPS_EV_POOLING_H_
#define TOPI_SNPS_EV_POOLING_H_
...
/*!
* \brief Create a snps_ev schedule for pool
*
...
/*!
* \brief Create a snps_ev schedule for global_pool
*
* \param target The target to generate a schedule for.
* \param outs The output tensors.
*
