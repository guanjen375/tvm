 ...
 */
#ifndef TOPI_SNPS_EV_INJECTIVE_H_
#define TOPI_SNPS_EV_INJECTIVE_H_
...
/*!
 * \brief Create a snps_ev schedule for the given output tensors.
 *
...
#endif  // TOPI_SNPS_EV_INJECTIVE_H_
