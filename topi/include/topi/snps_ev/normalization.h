...
/*!
 * \file snps_ev/normalization.h
 * \brief snps_ev schedule for LRN and l2 normalization operations
 */
#ifndef TOPI_SNPS_EV_NORMALIZATION_H_
#define TOPI_SNPS_EV_NORMALIZATION_H_
...
namespace snps_ev {
/*!
* \brief Create a snps_ev schedule for LRN
*
...
/*!
* \brief Create a snps_ev schedule for L2 Normalization
*
* \param target The target to generate a schedule for.
* \param outs The output tensors.
*
...
#endif  // TOPI_SNPS_EV_NORMALIZATION_H_
