...
/*!
 * \file snps_ev/reduction.h
 * \brief snps_ev schedule for reduction operations
 */
#ifndef TOPI_SNPS_EV_REDUCTION_H_
#define TOPI_SNPS_EV_REDUCTION_H_
...
/*!
* \brief Create a snps_ev schedule for a reduce operation.
*
* \param target The target to generate a schedule for.
...
#endif  // TOPI_SNPS_EV_REDUCTION_H_
