...
@generic.schedule_reorg.register(["snps_ev"])
def schedule_reorg(outs):
    ...
    return cpp.snps_ev.schedule_injective(cpp_target, outs)

@generic.schedule_nms.register(["snps_ev"])
...
@generic.schedule_multibox_prior.register(["snps_ev"])
...
@generic.schedule_multibox_transform_loc.register(["snps_ev"])
...
@generic.schedule_multibox_detection.register(["snps_ev"])
...
@generic.schedule_roi_align.register(["snps_ev"])
def schedule_roi_align(outs):
    return schedule_pool(outs, 'NCHW')

@generic.schedule_roi_pool.register(["snps_ev"])
def schedule_roi_pool(outs):
    return schedule_pool(outs, 'NCHW')

@generic.schedule_proposal.register(["snps_ev"])
...
@generic.schedule_get_valid_counts.register(["snps_ev"])
