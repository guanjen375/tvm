...
"""Conv2d transpose template for snps_ev backend"""
...
@autotvm.task.register_topi_compute(nn.conv2d_transpose_nchw, ['snps_ev'], "direct")
def conv2d_transpose_nchw_snps_ev(cfg, Input, Filter, strides, padding, out_dtype):
...
@autotvm.task.register_topi_schedule(generic.schedule_conv2d_transpose_nchw,
                                     ['snps_ev'], 'direct')
def schedule_conv2d_transpose_nchw_snps_ev(cfg, outs):
