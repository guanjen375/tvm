...
"""Schedule template of deformable conv2d with snps_ev backend"""
import tvm
...
autotvm.register_topi_compute(nn.deformable_conv2d_nchw, ["snps_ev"], "direct",
                              nn.deformable_conv2d_nchw.fdefault)


@autotvm.register_topi_schedule(generic.schedule_deformable_conv2d_nchw, ["snps_ev"], "direct")
def schedule_deformable_conv2d_nchw_snps_ev(cfg, outs):
    """TOPI schedule callback of deformable conv2d for snps_ev
...
def schedule_direct_snps_ev(cfg, s, conv):
