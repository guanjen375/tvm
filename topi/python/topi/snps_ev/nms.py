...
@get_valid_counts.register(["snps_ev"])
def get_valid_counts_snps_ev(data, score_threshold=0, id_index=0, score_index=1):
...
@non_max_suppression.register(["snps_ev"])
def non_max_suppression_snps_ev(data, valid_count, max_output_size=-1,
