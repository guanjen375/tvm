...
@multibox_prior.register(["snps_ev"])
def multibox_prior_snps_ev(data, sizes=(1,), ratios=(1,), steps=(-1, -1),
...
@multibox_transform_loc.register(["snps_ev"])
def multibox_transform_loc_snps_ev(cls_prob, loc_pred, anchor, clip=True, \
...
@multibox_detection.register(["snps_ev"])
def multibox_detection_snps_ev(cls_prob, loc_pred, anchor, clip=True, threshold=0.01, nms_threshold=0.5,
