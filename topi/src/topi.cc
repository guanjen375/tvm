...
#include <topi/snps_ev/dense.h>
#include <topi/snps_ev/injective.h>
#include <topi/snps_ev/pooling.h>
#include <topi/snps_ev/reduction.h>
#include <topi/snps_ev/softmax.h>
#include <topi/snps_ev/normalization.h>
...
/* snps_ev schedules */
TVM_REGISTER_GLOBAL("topi.snps_ev.dense_cuda")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = snps_ev::dense_snps_ev(args[0], args[1], args[2], args[3], args[4]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_dense")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_dense(args[0], args[1]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_injective")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_injective(args[0], args[1]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_injective_from_existing")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_injective_from_existing(args[0], args[1]);
 });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_pool")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_pool(args[0], args[1]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_global_pool")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_global_pool(args[0], args[1]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_reduce")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_reduce(args[0], args[1]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_softmax")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_softmax(args[0], args[1]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_lrn")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_lrn(args[0], args[1]);
  });

TVM_REGISTER_GLOBAL("topi.snps_ev.schedule_l2_normalize")
.set_body([](TVMArgs args, TVMRetValue *rv) {
  *rv = topi::snps_ev::schedule_l2_normalize(args[0], args[1]);
  });
...
.register_func({ "snps_ev" }, WrapSchedule(topi::snps_ev::schedule_injective))
...
.register_func({ "snps_ev" }, WrapSchedule(topi::snps_ev::schedule_softmax))
...
.register_func({ "snps_ev" }, WrapSchedule(topi::snps_ev::schedule_dense))
...
.set_default(WrapSchedule(topi::generic::default_schedule))
.register_func({ "cpu" }, WrapSchedule(topi::x86::default_schedule))
.register_func({ "snps_ev" }, WrapSchedule(topi::snps_ev::schedule_pool))
...
.register_func({ "snps_ev" }, WrapDenseOp(topi::snps_ev::dense_snps_ev))
