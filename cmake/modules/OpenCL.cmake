...
if(USE_SNPS_EV)
  message(STATUS "Build with SNPS_EV support")
  file(GLOB RUNTIME_SNPS_EV_SRCS src/runtime/snps_ev/*.cc)
  list(APPEND RUNTIME_SRCS ${RUNTIME_SNPS_EV_SRCS})
  if(NOT USE_OPENCL)
    message(STATUS "Enable OpenCL support required for SNPS_EV")
    set(USE_OPENCL ON) 
  endif()
else()
  list(APPEND COMPILER_SRCS src/codegen/opt/build_snps_ev_off.cc)
endif(USE_SNPS_EV)
